//W11 Weather API for Fish Haven Idaho
const requestURL ='https://api.openweathermap.org/data/2.5/forecast?id=5585010&units=imperial&APPID=d240e58805731cb6287c5e4f95fa6d71';
...
fetch(eventAPI)
  ...
  .then(jsonObject => {
    ...
    prestonEvents.forEach(event => {
      ...
      p.innerHTML = event;
      document.getElementById('FishHaven-events').appendChild(p);
    });
  })
  .catch(err => {
    document.getElementById('weatherSummary').innerHTML = err;
